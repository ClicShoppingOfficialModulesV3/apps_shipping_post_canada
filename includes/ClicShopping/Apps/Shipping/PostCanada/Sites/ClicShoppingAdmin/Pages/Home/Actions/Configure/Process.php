  ...
  class Process extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      ...
      foreach ($m->getParameters() as $key) {
        ...
        if (isset($_POST[$p])) {
          $CLICSHOPPING_PostCanada->saveCfgParam($key, $_POST[$p]);
        }
      }

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_PostCanada->getDef('alert_cfg_saved_success'), 'success', 'PostCanada');
